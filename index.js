...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    let newArray = [];
    zooAnimals.forEach((animal) => newArray.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`))
    return newArray;
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
   const newArray = zooAnimals.map((animal) => animal.animal_name.toLowerCase())
   return newArray;
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals) {
    const newArray = zooAnimals.filter((animal) => animal.population < 5);
    return newArray;
  }
  ...
  */
  ...
  function USApop(zooAnimals) {
    const totalPopulation = zooAnimals.reduce((acc, animal) => acc + animal.population, 0);
